...
//#################  PROJECT : Vaccine Scheduling And Hospital Record Management IN C++ //#################
//#################  PASSWORD FOR ADMIN SECTION : 1234
...
public:
    ...
    static void display_Admin(hospital h[]); // hospitals vaccine count and number of patient
...
void hospital::display_Admin(hospital h[])
{
...
void hospital::display_User(hospital h[])
{
...
//************************************************************************************************************************************
// user-operations
void userOperations::User_register(hospital *ptr)
{
    int cnt = 0, h = 0, m = 0;
    int flag;
...
void userOperations::cancel_registration(hospital *admin)
{
    string adnum;
...
void userOperations::user_data(hospital *admin)
{
...
int main()
{
    hospital admin[5];
    // database
    admin[0] = hospital(1, "LOCO HOSPITAL KANPUR", 2);
    admin[1] = hospital(2, "ANURAG HOSPITAL KANPUR", 40);
    admin[2] = hospital(3, "SAVITRI HOSPITAL KANPUR", 25);
    admin[3] = hospital(4, "GOVERNMENT HOSPITAL KANPUR", 15);
    admin[4] = hospital(5, "MADHURAJ HOSPITAL KANPUR", 30);
